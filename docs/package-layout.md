...
| Location | Purpose |
| --- | --- |
| `src/sashimi_si/` | Standard public API and model-specific implementation |
| `src/sashimi_si/_physics.py` | Existing physical prescriptions and observable kernels |
| `src/sashimi_si/_itamae_components.py` | Model stages used by ITAMAE population execution |
...
The standard `import sashimi_si` and previously distributed helper imports remain
